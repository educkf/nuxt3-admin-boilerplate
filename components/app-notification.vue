            ...
            >
                <div v-for="notification in list" :key="notification.id"
                    class="max-w-sm w-full bg-gray-700 text-white shadow-lg rounded-lg pointer-events-auto
                        ring-1 ring-black ring-opacity-5 overflow-hidden border-l-8 border-semeiosis-light"
                >
                    <div class="p-4">
                        <div class="flex items-start">
                            ...
                            <div class="ml-4 flex-shrink-0 flex">
                                <button @click.prevent="close(notification.id)" class="rounded-md inline-flex text-gray-200 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-semeiosis-light">
